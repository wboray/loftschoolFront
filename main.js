...
document.addEventListener("DOMContentLoaded", function (event) {
  var sheetCommand = document.querySelector('#sheet-command');
  var sheetCommandItems = document.querySelectorAll('.sheet-command__people');
  sheetCommand.addEventListener('click', function (event) {
    ...
    if (target.parentNode.classList.contains('sheet-command__title')) {
      var sheetCommandContent = target.parentNode;
      sheetCommandItems.forEach(function (element) {
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var formSubmit = document.querySelector('.form__btn-custom');
  var formReset = document.querySelector('.form__clear'); //const form = document.querySelector('#formid');
  ...
  formSubmit.addEventListener('click', function (event) {
    event.preventDefault(); //overlay.open();
  ...
  */
  ...
  var ajaxForm = function ajaxForm(form) {
    ...
    try {
      ...
      console.error(error.name + ': ' + error.message); //alert(1);
...
var player = void 0; //function youTubePlayer() {
...
document.addEventListener("DOMContentLoaded", function (event) {
  var menuSheet = document.querySelector('.sheet-menu__accordion-items');
  ...
  function managerMenu(menuItem) {
    if (menuItem.classList.contains('sheet-menu__accordion-item--active')) {
      ...
      menuSheet.childNodes.forEach(function (element) {
...
document.addEventListener("DOMContentLoaded", function (event) {
  var thanksWindowButton = document.querySelector('#thanks-window-button');
  var thanksWindow = document.querySelector('#thanks-window');
  var buttons = document.querySelectorAll(".btn[data-goto-form='1']");
  var body = document.querySelector('body');
  var html = document.querySelector('html');
  var classes = ['active', 'hidden'];
  var elements = [thanksWindow, body];
  /*
  ...
  buttons.forEach(function (element) {
    element.addEventListener('click', function (event) {
      event.preventDefault();
      var section = document.querySelector('#sheet-form').offsetTop;
...
window.addEventListener("load", function (event) {
  ...
  var hamburgerOverlayClose = document.querySelector('#hamburger-overlay__close');
  var fixedMenu = document.querySelector('#fp-nav');
  var navMainItem = document.querySelectorAll('#nav-main__list>li');
  var navigationFixed = document.querySelector('.navigation');
  var navMainItemLink;
  var firstLoad = true;
  var body = document.querySelector('body');
  var html = document.querySelector('html');
  var classes = ['active', 'hidden'];
  var elements = [hamburgerOverlay, body];

  function navigationPageActive(target) {
    navigationFixed.querySelectorAll('.navigation__page').forEach(function (element) {
      //console.log(element);
  ...
  */
  ...
  function fp(responsiveWidth, responsiveHeight) {
    var myFullpage = new fullpage('#fullpage', {
      ...
      anchors: ['sheetfirst', 'sheetwhy', 'sheetchocco', 'sheetcommand', 'sheetmenu', 'sheetreviews', 'sheethowwork', 'sheetform', 'sheetcontact'],
      ...
      responsiveHeight: responsiveHeight //navigationTooltips: ['First page', 'Second page', 'Third and last page']
  ...
  if ($(window).outerWidth() <= 480 && md.mobile()) {
    ...
    var responsiveHeight = false;
    fp(responsiveWidth, responsiveHeight);
  } else if ($(window).outerWidth() <= 768 && md.mobile()) {
    var _responsiveWidth = 768;
    var _responsiveHeight = false;
    fp(_responsiveWidth, _responsiveHeight);
  } else {
    var _responsiveWidth2 = 768;
    var _responsiveHeight2 = 650;
    fp(_responsiveWidth2, _responsiveHeight2);
  }
});

var _toggleClass = function _toggleClass(element, className) {
  element.forEach(function (item, index) {
    return item.classList.toggle(className[index]);
  });
};
...
function createOverlay(template, body) {
  ...
  var closeElement = fragment.querySelector('#close-overlay');
  fragment = null;
...
;
document.addEventListener("DOMContentLoaded", function (event) {
  var items = document.querySelectorAll('.sliderTwo-item');
  var itemArrow = document.querySelector('.sheet-reviews__peoples');
  var itemsArrow = document.querySelectorAll('.sheet-reviews__peoples-item');
  var activeItem = 0;
  var i = 0;
  ...
  i = 0;
  itemsArrow.forEach(function (element) {
    element.setAttribute('data-index-arrow', i);
    i++;
  });
  itemArrow.addEventListener('click', function (event) {
    event.preventDefault();
    var target = event.target; //console.log(target.parentElement);
...
document.addEventListener("DOMContentLoaded", function (event) {
  var sliders = ['#slider-sheet-chocco'];
  sliders.forEach(function (element) {
    var excludeArray = ['btn'];
    var slider = document.querySelector(element);
    var arrowLeft = document.querySelector(element + '>.slider__left');
    var arrowRight = document.querySelector(element + '>.slider__right');
    var items = document.querySelector(element + '>.slider__items');
    var itemArray = [];
    var cloneFirst;
    var cloneEnd;
    var itemActive; //клонирование первого и последнего элемента,
    ...
    items.childNodes.forEach(function (element) {
      if (element.classList !== undefined && element.classList.contains('slider__item')) {
        ...
        if (i == 0) {
          itemActive = 0; //itemArray[0].setAttribute('data-item-active', 'active');
    ...
    items.insertBefore(cloneEnd, items.children[0]); //после вставки нужно пересчитать массив итемов

    var itemArrayWithClone = [];
    ...
    function gotoSlide(item, revers) {
      ...
      if (revers > 0) {
        //console.log(revers);
        itemArray[0].addEventListener('transitionend', transitionEnd()); //debugger;
      }
